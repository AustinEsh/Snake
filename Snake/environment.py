...
class Environment():
    ...
    def moveSnake(self, nextPos, currentPos, col):    
        ...
        if action == 0:
            if snakeY > 0:
                if self.screenMap[snakeY - 1][snakeX] == 0.5:
                    ...
                    self.moveSnake((snakeY - 1, snakeX), (snakeY, snakeX), True)
                elif self.screenMap[snakeY - 1][snakeX] == 0:
                    self.moveSnake((snakeY - 1, snakeX), (snakeY, snakeX), False)
            else:
                gameOver = True
                reward = self.negReward
            ...
            if snakeX < self.nColumns - 1:
                if self.screenMap[snakeY][snakeX + 1] == 0.5:
                    ...
                    reward = self.posReward
                    self.moveSnake((snakeY, snakeX + 1), (snakeY, snakeX), True)
                elif self.screenMap[snakeY][snakeX + 1] == 0:
                    self.moveSnake((snakeY, snakeX + 1), (snakeY, snakeX), False)
            else:
                gameOver = True
                reward = self.negReward 
